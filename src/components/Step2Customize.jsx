...
export const FRAMES = [
    // 🌿 BSU & TECH INNOVATORS SOCIETY — SDG 13 GRAPHIC FRAME THEMES (7 COLOR PALETTES)
    {
        id: 'sdg_climate_emerald',
        label: 'SDG 13 Emerald Green',
        sub: 'Tech Innovators Society · Climate Action',
        tag: 'SDG 13 EMERALD',
        pattern: 'sdg_emerald_mockup',
        cardBg: '#EBF6EE',
        accent: '#1E7E34',
    },
    {
...
function FrameMockupPreview({ pattern }) {
    switch (pattern) {
        case 'sdg_emerald_mockup':
            return (
                <div className="mockup-sdg-frame" style={{ '--sdg-border': '#1E7E34', '--sdg-header': '#0B3B17', '--sdg-hill': '#52B788', '--sdg-badge': '#1E7E34' }}>
                    <div className="sdg-mockup-header">
                        <img src="/Batangas_State_Logo.png" alt="BSU" className="sdg-mockup-logo-left" onError={(e) => { e.target.style.display = 'none'; }} />
                        <span className="sdg-mockup-title">SDG 13 · TECH IS</span>
                        <img src="/logo.png" alt="Tech IS" className="sdg-mockup-logo-right" onError={(e) => { e.target.style.display = 'none'; }} />
                    </div>
                    <div className="sdg-mockup-slot" />
                    <div className="sdg-mockup-footer">
                        <span className="sdg-mockup-hills" />
                        <div className="sdg-mockup-badge">
                            <span className="sdg-mockup-num">13</span>
                            <span className="sdg-mockup-tag">CLIMATE</span>
                        </div>
                    </div>
                </div>
            );
        case 'sdg_ocean_mockup':
            return (
                <div className="mockup-sdg-frame" style={{ '--sdg-border': '#0077B6', '--sdg-header': '#05294A', '--sdg-hill': '#48CAE4', '--sdg-badge': '#0077B6' }}>
                    <div className="sdg-mockup-header">
                        <img src="/Batangas_State_Logo.png" alt="BSU" className="sdg-mockup-logo-left" onError={(e) => { e.target.style.display = 'none'; }} />
                        <span className="sdg-mockup-title">SDG 13 · OCEAN</span>
                        <img src="/logo.png" alt="Tech IS" className="sdg-mockup-logo-right" onError={(e) => { e.target.style.display = 'none'; }} />
                    </div>
                    <div className="sdg-mockup-slot" />
                    <div className="sdg-mockup-footer">
        ...
        case 'sdg_crimson_mockup':
            return (
                <div className="mockup-sdg-frame" style={{ '--sdg-border': '#BA181B', '--sdg-header': '#590004', '--sdg-hill': '#E5383B', '--sdg-badge': '#BA181B' }}>
                    <div className="sdg-mockup-header">
                        <img src="/Batangas_State_Logo.png" alt="BSU" className="sdg-mockup-logo-left" onError={(e) => { e.target.style.display = 'none'; }} />
                        <span className="sdg-mockup-title">SDG 13 · SPARTAN</span>
                        <img src="/logo.png" alt="Tech IS" className="sdg-mockup-logo-right" onError={(e) => { e.target.style.display = 'none'; }} />
                    </div>
                    <div className="sdg-mockup-slot" />
                    <div className="sdg-mockup-footer">
        ...
        case 'sdg_violet_mockup':
            return (
                <div className="mockup-sdg-frame" style={{ '--sdg-border': '#7B2CBF', '--sdg-header': '#240046', '--sdg-hill': '#C77DFF', '--sdg-badge': '#5A189A' }}>
                    <div className="sdg-mockup-header">
                        <img src="/Batangas_State_Logo.png" alt="BSU" className="sdg-mockup-logo-left" onError={(e) => { e.target.style.display = 'none'; }} />
                        <span className="sdg-mockup-title">SDG 13 · VIOLET</span>
                        <img src="/logo.png" alt="Tech IS" className="sdg-mockup-logo-right" onError={(e) => { e.target.style.display = 'none'; }} />
                    </div>
                    <div className="sdg-mockup-slot" />
                    <div className="sdg-mockup-footer">
        ...
        case 'sdg_amber_mockup':
            return (
                <div className="mockup-sdg-frame" style={{ '--sdg-border': '#D97706', '--sdg-header': '#4A2503', '--sdg-hill': '#FBBF24', '--sdg-badge': '#D97706' }}>
                    <div className="sdg-mockup-header">
                        <img src="/Batangas_State_Logo.png" alt="BSU" className="sdg-mockup-logo-left" onError={(e) => { e.target.style.display = 'none'; }} />
                        <span className="sdg-mockup-title">SDG 13 · SUNSET</span>
                        <img src="/logo.png" alt="Tech IS" className="sdg-mockup-logo-right" onError={(e) => { e.target.style.display = 'none'; }} />
                    </div>
                    <div className="sdg-mockup-slot" />
                    <div className="sdg-mockup-footer">
        ...
        case 'sdg_sakura_mockup':
            return (
                <div className="mockup-sdg-frame" style={{ '--sdg-border': '#C9184A', '--sdg-header': '#47081A', '--sdg-hill': '#FF8FA3', '--sdg-badge': '#C9184A' }}>
                    <div className="sdg-mockup-header">
                        <img src="/Batangas_State_Logo.png" alt="BSU" className="sdg-mockup-logo-left" onError={(e) => { e.target.style.display = 'none'; }} />
                        <span className="sdg-mockup-title">SDG 13 · SAKURA</span>
                        <img src="/logo.png" alt="Tech IS" className="sdg-mockup-logo-right" onError={(e) => { e.target.style.display = 'none'; }} />
                    </div>
                    <div className="sdg-mockup-slot" />
                    <div className="sdg-mockup-footer">
        ...
        case 'sdg_noir_mockup':
            return (
                <div className="mockup-sdg-frame" style={{ '--sdg-border': '#D4AF37', '--sdg-header': '#111111', '--sdg-hill': '#555555', '--sdg-badge': '#1A1A1A' }}>
                    <div className="sdg-mockup-header">
                        <img src="/Batangas_State_Logo.png" alt="BSU" className="sdg-mockup-logo-left" onError={(e) => { e.target.style.display = 'none'; }} />
                        <span className="sdg-mockup-title" style={{ color: '#D4AF37' }}>SDG 13 · NOIR</span>
                        <img src="/logo.png" alt="Tech IS" className="sdg-mockup-logo-right" onError={(e) => { e.target.style.display = 'none'; }} />
                    </div>
                    <div className="sdg-mockup-slot" />
                    <div className="sdg-mockup-footer">
                        <span className="sdg-mockup-hills" />
                        <div className="sdg-mockup-badge" style={{ borderColor: '#D4AF37', color: '#D4AF37' }}>
                            <span className="sdg-mockup-num">13</span>
                            <span className="sdg-mockup-tag">CLIMATE</span>
                        </div>
                    </div>
...
export default function Step2Customize({
    ...
    const [frameCategory, setFrameCategory] = useState('all'); // 'all' | 'sdg' | 'brainrot' | 'climate' | 'red' | 'aesthetic'

    const categoryCounts = useMemo(() => ({
        all: availableFrames.length,
        sdg: availableFrames.filter(f => f.id.startsWith('sdg_')).length,
        brainrot: availableFrames.filter(f => f.id.startsWith('brainrot_')).length,
        climate: availableFrames.filter(f => f.id.startsWith('climate') || f.id.startsWith('sdg_')).length,
        ...
        aesthetic: availableFrames.filter(f => !f.id.startsWith('sdg_') && !f.id.startsWith('climate') && !f.id.startsWith('brainrot_') && !f.id.startsWith('spartan') && !f.id.startsWith('cherry') && !f.id.startsWith('cyber_scarlet') && !f.id.startsWith('klique')).length,
    }), [availableFrames]);

    const displayedFrames = useMemo(() => {
        if (frameCategory === 'sdg') return availableFrames.filter(f => f.id.startsWith('sdg_'));
        if (frameCategory === 'brainrot') return availableFrames.filter(f => f.id.startsWith('brainrot_'));
        if (frameCategory === 'climate') return availableFrames.filter(f => f.id.startsWith('climate') || f.id.startsWith('sdg_'));
        ...
        if (frameCategory === 'aesthetic') return availableFrames.filter(f => !f.id.startsWith('sdg_') && !f.id.startsWith('climate') && !f.id.startsWith('brainrot_') && !f.id.startsWith('spartan') && !f.id.startsWith('cherry') && !f.id.startsWith('cyber_scarlet') && !f.id.startsWith('klique'));
    ...
    const handleSelectCategory = (cat) => {
        ...
        if (cat === 'sdg') newFrames = availableFrames.filter(f => f.id.startsWith('sdg_'));
        else if (cat === 'brainrot') newFrames = availableFrames.filter(f => f.id.startsWith('brainrot_'));
        else if (cat === 'climate') newFrames = availableFrames.filter(f => f.id.startsWith('climate') || f.id.startsWith('sdg_'));
        ...
        else if (cat === 'aesthetic') newFrames = availableFrames.filter(f => !f.id.startsWith('sdg_') && !f.id.startsWith('climate') && !f.id.startsWith('brainrot_') && !f.id.startsWith('spartan') && !f.id.startsWith('cherry') && !f.id.startsWith('cyber_scarlet') && !f.id.startsWith('klique'));
    ...
    useEffect(() => {
        if (canvasRef.current && shots && shots.length > 0) {
            renderPhotoStrip(canvasRef.current, shots, selectedFrame, selectedFilter, logoImg, selectedLayout, stickers, bsuLogoImg);
        }
    }, [shots, selectedLayout, selectedFrame, selectedFilter, stickers, logoImg, bsuLogoImg]);
                    ...
                    <div className="tab-content">
                        ...
                        <div className="frame-slideshow-container">
                            ...
                            <div className="frame-category-pills">
                                ...
                                <button
                                    type="button"
                                    className={`frame-cat-pill ${frameCategory === 'sdg' ? 'active' : ''}`}
                                    onClick={() => handleSelectCategory('sdg')}
                                >
                                    <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2.2" style={{ marginRight: '4px' }}>
                                        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
                                    </svg>
                                    SDG Frames ({categoryCounts.sdg})
                                </button>
                                <button
                                    type="button"
