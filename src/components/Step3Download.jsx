...
export default function Step3Download({
        ...
        const processAndUpload = async () => {
            try {
                ...
                if (canvasRef.current && shots && shots.length > 0) {
                    await renderPhotoStrip(canvasRef.current, shots, selectedFrame, selectedFilter, logoImg, selectedLayout, stickers, bsuLogoImg);
                }
                ...
                const reelBlob = await buildVideoReel(videoClips, selectedFrame, selectedFilter, logoImg, selectedLayout, stickers, bsuLogoImg);
    ...
    }, [shots, videoClips, selectedLayout, selectedFrame, selectedFilter, logoImg, bsuLogoImg]);
